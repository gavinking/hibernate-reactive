...
import org.hibernate.rx.containers.SQLServerDatabase;
...
public class SQLServerBasicTest extends BaseRxTest {

	@Override
	protected Configuration constructConfiguration() {
		Configuration configuration = super.constructConfiguration();
		configuration.setProperty( AvailableSettings.URL, SQLServerDatabase.getJdbcUrl() );
		configuration.setProperty( AvailableSettings.DIALECT, SQLServer2012Dialect.class.getName());
...
//		basik.localTime = LocalTime.now();
		...
		test( context,
				openSession()
//				.thenCompose(s -> s.find(Basic.class, 1))
//				.thenApply(context::assertNull)
